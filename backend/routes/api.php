...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        // Decisionnel / Analytics
        Route::prefix('decisionnel')->group(function () {
            Route::get('/overview', [AnalyticsController::class, 'getOverview']);
            Route::get('/top-consumers', [AnalyticsController::class, 'getTopConsumers']);
            Route::get('/top-products', [AnalyticsController::class, 'getTopProducts']);
            Route::get('/trends', [AnalyticsController::class, 'getMovementTrends']);
            Route::get('/live-monitoring', [AnalyticsController::class, 'getLiveMonitoring']);
            Route::get('/alerts', [AnalyticsController::class, 'getAlerts']);
            Route::patch('/alerts/{id}/read', [AnalyticsController::class, 'markAlertAsRead']);
            Route::get('/insights', [AnalyticsController::class, 'getInsights']);
            Route::get('/export/daily-summary', [AnalyticsController::class, 'exportDailySummary']);
            Route::get('/export/inventory', [AnalyticsController::class, 'exportInventory']);
            Route::get('/export/movements', [AnalyticsController::class, 'exportMovements']);
        });
    });
});
