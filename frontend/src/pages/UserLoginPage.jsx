            ...
            <div className="ul-container">
                ...
                <div className="ul-card">
                    ...
                    <div style={{ textAlign: 'center', marginTop: '1.5rem' }}>
                        <Link to="/" style={{ color: '#1a56db', textDecoration: 'none', fontWeight: 500, fontSize: '0.9rem', display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
                            <span>&larr;</span> Retour au choix du profil
                        </Link>
                    </div>
